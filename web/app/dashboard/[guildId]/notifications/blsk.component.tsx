...
export function BlueskyNotificationModal({
    ...
    return (<>
        ...
        >
            <Searchbar
                name="Bluesky user"
                placeholder="blueskyuser.bsky.social"
                value={name}
                setValue={setName}
            />
            ...
            <div className="mt-4">
                ...
                Your handle is likely something like <code className="break-all">randomuser.bsky.social</code>, some others may have a handle like <code>shi.gg</code>.
                <br />
                <br />
