                        ...
                        >
                            {item.creator.avatarUrl
                                ? <Image
                                    ...
                                    height={46}
                                />
                                : <div className="size-[46px] flex items-center justify-center bg-flame rounded-full select-none font-medium text-lg text-neutral-200">
        ...
        <Navigation
            ...
            avatar={item.creator.avatarUrl
                ? <Image
                    ...
                    height={24}
                />
                : <div className="size-[24px] flex items-center justify-center bg-flame rounded-full select-none font-medium text-sm text-neutral-200">
                    {item.creator.username.slice(0, 2)}
                </div>
            }
    ...
    if (type === NotificationType.Reddit) {
        return (
            <Button
                className="w-1/3 md:w-1/6 relative top-8 flex"
                onClick={() => {
                    window.open(`https://reddit.com/r/${creatorId}/submit?title=${encodeURIComponent("Test Reddit to Discord Notifications")}&url=${encodeURIComponent(getCanonicalUrl("docs", "notifications"))}`);
                }}
                size="lg"
                variant="flat"
            >
