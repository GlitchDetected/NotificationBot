...
export default function Home() {
  ...
  return (
    <div className="relative flex items-center flex-col w-full p-8 min-h-screen px-5 md:px-8 lg:px-12 xl:px-16 py-8 z-10" id="home" ref={ref}>
      {/* Hero Section */}
      <motion.div
  ...
  <span className={cn("lg:ml-auto flex gap-2 text-neutral-500 font-medium -mt-2 opacity-80 pl-20 lg:pr-20 rotate-2 relative -top-10", handwritten.className)}>
