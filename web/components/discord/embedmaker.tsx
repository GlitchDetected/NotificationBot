...
export default function MessageCreatorEmbed({
    ...
    const modeToggle = (
        <div
            className={cn(
                mode === "DARK" ? "bg-flame-light" : "bg-flame-100-light",
    ...
    return (
        <div>
            <div
                className={cn(
                    "mt-8 mb-4 border-2 dark:border-flame border-flame-100 rounded-xl md:px-4 md:pb-4 px-2 py-2",
                            ...
                            >
                                ...
                                <DiscordMessage
                                    ...
                                    user={{
                                        ...
                                        avatar: "/images/notificationbot.png",
                                        bot: true
                                    }}
                                >
                                    <DiscordMarkdown
